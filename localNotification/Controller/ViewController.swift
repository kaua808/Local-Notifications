...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(handleAction(_:)), name: Notification.Name(rawValue: "internalNotification.handleAction"), object: nil)
    }
